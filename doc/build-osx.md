...
-------
    ...
    ./src/avaloncoind -daemon # Starts the bitcoin daemon.
    ./src/avaloncoin-cli --help # Outputs a list of command-line options.
    ./src/avaloncoin-cli help # Outputs a list of RPC commands when the daemon is running.
