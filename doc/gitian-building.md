...
Clone the git repositories for avaloncoin and Gitian.
...
Output from `gbuild` will look something like
    ...
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/avaloncoin/.git/
...
For example:
```bash
URL=https://github.com/akx20000a/avaloncoin.git
COMMIT=d5522ed66a924a2d505fe45ed2487e741c6c0917
./bin/gbuild --commit avaloncoin=${COMMIT} --url avaloncoin=${URL} ../avaloncoin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit avaloncoin=${COMMIT} --url avaloncoin=${URL} ../avaloncoin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit avaloncoin=${COMMIT} --url avaloncoin=${URL} ../avaloncoin/contrib/gitian-descriptors/gitian-osx.yml
```
...
[avaloncoin/gitian.sigs](https://github.com/avaloncoin/gitian.sigs/) repository, or if that's not possible create a pull
request.
