...
Source10:	https://raw.githubusercontent.com/avaloncoin/avaloncoin/master/contrib/debian/examples/avaloncoin.conf
...
cp -p %{SOURCE10} ./avaloncoin.conf.example
tar -zxf %{SOURCE1}
...
cat <<EOF > %{buildroot}%{_tmpfilesdir}/avaloncoin.conf
d /run/bitcoind 0750 bitcoin bitcoin -
EOF
touch -a -m -t 201504280000 %{buildroot}%{_tmpfilesdir}/avaloncoin.conf
...
CONFIG_FILE="%{_sysconfdir}/bitcoin/avaloncoin.conf"
DATA_DIR="%{_localstatedir}/lib/bitcoin"
PID_FILE="/run/bitcoind/avaloncoind.pid"
EOF
...
%doc COPYING avaloncoin.conf.example doc/README.md doc/bips.md doc/files.md doc/multiwallet-qt.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
...
%defattr(-,root,root,-)
%license COPYING db-%{bdbv}.NC-LICENSE
%doc COPYING avaloncoin.conf.example doc/README.md doc/REST-interface.md doc/bips.md doc/dnsseed-policy.md doc/files.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
%attr(0755,root,root) %{_sbindir}/bitcoind
%attr(0644,root,root) %{_tmpfilesdir}/avaloncoin.conf
...
%defattr(-,root,root,-)
%license COPYING
%doc COPYING avaloncoin.conf.example doc/README.md
